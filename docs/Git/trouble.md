...
### pullでNeed to specify how to reconcile divergent branches
...
push済みのコミットとrebaseして追加されたコミットで情報が食い違ってる場合などで発生。  
`git pull --rebase`すれば取り込める。
